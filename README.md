...
Cartoon character pack — vector-style avatars with full-body avatars, circular profile pics, and a set of 6 expression/pose stickers, all as PNGs (transparent background where noted).
...
- `profile.png` — 1024×1024 circular profile with a vivid multi-color background
- `poses/01-hello.png` — waving hi
- `poses/02-excited.png` — excited / thrilled
- `poses/03-laughing.png` — laughing
- `poses/04-intro.png` — introducing himself, smiling
- `poses/05-celebrating.png` — celebrating
